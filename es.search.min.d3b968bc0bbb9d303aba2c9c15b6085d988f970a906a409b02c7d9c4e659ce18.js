...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/peru-congreso/flexsearch.min.js');loadScript('/peru-congreso/es.search-data.min.8d8ac686d1b8bcbdf25beb5aea997cd5638e1574cbc0110507a326b39fa06f63.js',function(){input.required=false;search();});}
