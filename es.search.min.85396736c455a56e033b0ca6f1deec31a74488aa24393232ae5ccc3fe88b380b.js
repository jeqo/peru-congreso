...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/peru-congreso/flexsearch.min.js');loadScript('/peru-congreso/es.search-data.min.0358ceaabb0444923a3b0744a3fe246ab6d99cad777bedc384a64fbca33c08be.js',function(){input.required=false;search();});}
