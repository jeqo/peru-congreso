...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/peru-congreso/flexsearch.min.js');loadScript('/peru-congreso/es.search-data.min.22fef31467be302eca8b0d3251625d17bcb52b466d7ee67666592aea0e233bca.js',function(){input.required=false;search();});}
