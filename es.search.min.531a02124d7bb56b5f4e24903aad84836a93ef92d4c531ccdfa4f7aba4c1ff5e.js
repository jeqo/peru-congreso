...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/peru-congreso/flexsearch.min.js');loadScript('/peru-congreso/es.search-data.min.dd12481d8332716accd4a8e5cd9924f39cd1bb994a3af76881978117bacdf400.js',function(){input.required=false;search();});}
