...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/peru-congreso/flexsearch.min.js');loadScript('/peru-congreso/es.search-data.min.eaebb6af2b90cc1410a62d96db847ff6eaaeeaff06ae51de0cce11f705778522.js',function(){input.required=false;search();});}
