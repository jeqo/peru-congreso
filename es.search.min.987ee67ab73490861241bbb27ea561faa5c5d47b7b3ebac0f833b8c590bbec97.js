...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/peru-congreso/flexsearch.min.js');loadScript('/peru-congreso/es.search-data.min.eba9b47f1a86f8f110c883373f52aa67acea110cc19cabdba1b2a9b52b6fdc9e.js',function(){input.required=false;search();});}
