...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/peru-congreso/flexsearch.min.js');loadScript('/peru-congreso/es.search-data.min.0987e325b2d3b123c97cfe283c90ecd53fbdf3cbde9db5da907e056d5111eb9e.js',function(){input.required=false;search();});}
