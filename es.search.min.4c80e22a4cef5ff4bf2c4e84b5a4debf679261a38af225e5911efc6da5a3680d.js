...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/peru-congreso/flexsearch.min.js');loadScript('/peru-congreso/es.search-data.min.c8ec90fd41f8a2cd81b751de7106ccaffa034bb861d65348606dd5bb8195d3d5.js',function(){input.required=false;search();});}
