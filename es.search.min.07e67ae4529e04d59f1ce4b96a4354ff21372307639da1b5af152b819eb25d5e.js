...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/peru-congreso/flexsearch.min.js');loadScript('/peru-congreso/es.search-data.min.c5990672d9e9063dd4148e25d4ffacbe58efa6f328e41d63db51dd2bd12856b5.js',function(){input.required=false;search();});}
