...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/peru-congreso/flexsearch.min.js');loadScript('/peru-congreso/es.search-data.min.7090652023c99d2de8544456013554a9a6f4441241cf5b679b5e8367a3e914ed.js',function(){input.required=false;search();});}
