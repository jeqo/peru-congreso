...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/peru-congreso/flexsearch.min.js');loadScript('/peru-congreso/es.search-data.min.89d293c29a33a15933aeba88c3a606aad6e9c20b5cfe869ef3b106088702504a.js',function(){input.required=false;search();});}
