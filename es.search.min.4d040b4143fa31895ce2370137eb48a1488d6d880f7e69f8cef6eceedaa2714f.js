...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/peru-congreso/flexsearch.min.js');loadScript('/peru-congreso/es.search-data.min.089015c675ead962af488aff114fece283c229c5240d9581eaa5bc3ea2c4020e.js',function(){input.required=false;search();});}
