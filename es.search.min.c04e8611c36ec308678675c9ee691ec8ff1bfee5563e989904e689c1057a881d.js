...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/peru-congreso/flexsearch.min.js');loadScript('/peru-congreso/es.search-data.min.8881d389a9a8e0d6f11c14dd7fd39db4a2ea962154b7a56a8f48409415aa58f4.js',function(){input.required=false;search();});}
