...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/peru-congreso/flexsearch.min.js');loadScript('/peru-congreso/es.search-data.min.99d0cf4120541f545ad834ed08b32a13f0aeebf396b4cde679c67a374c66961f.js',function(){input.required=false;search();});}
