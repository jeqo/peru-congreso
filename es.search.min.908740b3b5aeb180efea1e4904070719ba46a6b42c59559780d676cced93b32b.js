...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/peru-congreso/flexsearch.min.js');loadScript('/peru-congreso/es.search-data.min.0f8f544c523d66e4a7e59de4c1436636a039a188b0a9a2d197600879ba4660a7.js',function(){input.required=false;search();});}
