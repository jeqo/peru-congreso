...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/peru-congreso/flexsearch.min.js');loadScript('/peru-congreso/es.search-data.min.7580ac65102910f5d7734a1288644ae14d3c7d4eb199c5485e46ca348abf2040.js',function(){input.required=false;search();});}
